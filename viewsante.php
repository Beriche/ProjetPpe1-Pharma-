...
<?php
       ...
       foreach ($produits->getsante() as $ligne) {
           ...
           //echo "<p class='imge'>" .$ligne['image_med'] ."</p>";
            echo "<a class='imge'  href='index.php?action=info&id=" . $ligne['id_med'] . "'>" . $ligne['image_med']."</a>" ;
             echo "<div class='info'> ";
...
<div align='center'>
  ...
  <a class="page" href="?action=Page&page=<?php echo $page - 1; ?>">Page précédente</a> 
      — 
  <a class="page" href="?action=Page&page=<?php echo $page + 1; ?>">Page suivante</a>
